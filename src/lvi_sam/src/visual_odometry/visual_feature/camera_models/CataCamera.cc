...
bool
CataCamera::Parameters::readFromYamlFile(std::shared_ptr<rclcpp::Node> node, const std::string& filename)
{
    ...
    // node->declare_parameter("model_type", "MEI");
    ...
    node->get_parameter("camera_name", m_cameraName);
    // fs["camera_name"] >> m_cameraName;
    // node->declare_parameter("image_width", 720);
    node->get_parameter("image_width", m_imageWidth);
    // node->declare_parameter("image_height", 540);
    node->get_parameter("image_height", m_imageHeight);
    // m_imageWidth = static_cast<int>(fs["image_width"]);
    // m_imageHeight = static_cast<int>(fs["image_height"]);

    cv::FileNode n;// = fs["mirror_parameters"];
    node->declare_parameter("mirror_parameters.xi", 1.0);
    node->get_parameter("mirror_parameters.xi", m_xi);
    // m_xi = static_cast<double>(n["xi"]);

    // n = fs["distortion_parameters"];
    node->declare_parameter("distortion_parameters.k1", 1.0);
    node->get_parameter("distortion_parameters.k1", m_k1);
    node->declare_parameter("distortion_parameters.k2", 1.0);
    node->get_parameter("distortion_parameters.k2", m_k2);
    node->declare_parameter("distortion_parameters.p1", 1.0);
    node->get_parameter("distortion_parameters.p1", m_p1);
    node->declare_parameter("distortion_parameters.p2", 1.0);
    node->get_parameter("distortion_parameters.p2", m_p2);
    ...
    node->declare_parameter("projection_parameters.gamma1", 1.0);
    node->get_parameter("projection_parameters.gamma1", m_gamma1);
    node->declare_parameter("projection_parameters.gamma2", 1.0);
    node->get_parameter("projection_parameters.gamma2", m_gamma2);
    node->declare_parameter("projection_parameters.u0", 1.0);
    node->get_parameter("projection_parameters.u0", m_u0);
    node->declare_parameter("projection_parameters.v0", 1.0);
    node->get_parameter("projection_parameters.v0", m_v0);
...
CataCamera::Parameters::writeToYamlFile(const std::string& filename) const
{
    ...
    // node->declare_parameter("model_type", "MEI");
    // node->get_parameter("model_type", modelType_temp);
