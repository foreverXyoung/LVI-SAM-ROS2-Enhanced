...
bool
EquidistantCamera::Parameters::readFromYamlFile(std::shared_ptr<rclcpp::Node> node, const std::string& filename)
{
    ...
    node->declare_parameter("projection_parameters.k2", 1.0);
    node->get_parameter("projection_parameters.k2", m_k2);
    node->declare_parameter("projection_parameters.k3", 1.0);
    node->get_parameter("projection_parameters.k3", m_k3);
    node->declare_parameter("projection_parameters.k4", 1.0);
    node->get_parameter("projection_parameters.k4", m_k4);
    node->declare_parameter("projection_parameters.k5", 1.0);
    node->get_parameter("projection_parameters.k5", m_k5);
    node->declare_parameter("projection_parameters.mu", 1.0);
    node->get_parameter("projection_parameters.mu", m_mu);
    node->declare_parameter("projection_parameters.mv", 1.0);
    node->get_parameter("projection_parameters.mv", m_mv);
