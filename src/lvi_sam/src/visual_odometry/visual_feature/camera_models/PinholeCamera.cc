...
bool
PinholeCamera::Parameters::readFromYamlFile(std::shared_ptr<rclcpp::Node> node, const std::string& filename)
{
    ...
    node->declare_parameter("projection_parameters.fx", 1.0);
    node->get_parameter("projection_parameters.fx", m_fx);
    node->declare_parameter("projection_parameters.fy", 1.0);
    node->get_parameter("projection_parameters.fy", m_fy);
    node->declare_parameter("projection_parameters.cx", 1.0);
    node->get_parameter("projection_parameters.cx", m_cx);
    node->declare_parameter("projection_parameters.cy", 1.0);
    node->get_parameter("projection_parameters.cy", m_cy);
