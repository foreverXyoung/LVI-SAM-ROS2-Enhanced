...
class FeatureTracker
{
  public:
    ...
    void readIntrinsicParameter(std::shared_ptr<rclcpp::Node> n, const string &calib_file);
...
public:
                                               ...
                                               const vector<geometry_msgs::msg::Point32>& features_2d)
    {
        ...
        try {
            transform = tf_buffer_->lookupTransform("vins_world", "vins_body_ros", stamp_cur, rclcpp::Duration::from_seconds(0.01));
